...
PREMIUM_EMOJI_IDS = {
    ...
    "🔄": "5971837723676249096",   # 🌀 Neon Circle Rings
    "⏳": "5971837723676249096",   # 🌀ChiragChiragchirgg_911
...
def create_result_card():
    ...
    draw.text(
        (80, 250),
        "🍷 Powered By ꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳 ︎",
        font=alone_font,
        fill=(0, 200, 255)
    )
...
async def update_progress(user_id, message_id, results, current_attempt_count, first_name="User", is_razorpay=False):
    ...
    text = f"""<b>⚡ 𝙎𝙝𝙤𝙥𝙞𝙞 𝙓 𝐒𝐁 ?𝙧 ⚡</b>
━━━━━━━━━━━━━━━━━━━━
<b>💠 𝗚𝗔𝗧𝗘𝗪𝗔𝗬 ➜ {gateway}</b>
<b>🔄 𝗦𝗧𝗔𝗧𝗨𝗦 ➜ 𝗖𝗛𝗘𝗖𝗞𝗜𝗡𝗚...</b>
━━━━━━━━━━━━━━━━━━━━
<b>✅ 𝗖𝗛𝗘??𝗞𝗘𝗗 ➜ {checked}/{total}</b>
...
<b>🦄 𝗕𝗼𝘁 𝗕𝘆 ➜ <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a></b>"""
...
🦄 <b>Bot By: <a href="tg://user?id=6729601755"></a></b>"""
...
async def razorpay_bulk_check(event):
    ...
    if not is_admin(user_id):
        await event.reply(premium_emoji(
            ...
            "<b>👤 <a href='tg://user?id=6903379369'>@II_SB_SIMPLE_II</a></b>\n\n"
            "<b>━━━━━━━━━━━━━━━━━━━━</b>\n"
            "<b>🦄 Bot By: ꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</b>"
        ), parse_mode='html')
        return
...
🦄 <b>Bot By: <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a></b>"""
...
🔄 <b>GET PREMIUM</b>
Contact <a href="tg://user?id=6729601755">@</a> for keys
...
<b>✅ Joined: {joined}</b>
━━━━━━━━━━━━━━━━━━━━
<b>👑 Dev: <a href="tg://user?id=6903379369"></a></b>
━━━━━━━━━━━━━━━━━━━━
...
<b>• UPI • PayPal • Crypto</b>"""
    ...
    support_buttons = [
        [
            Button.url("𝘽𝙐𝙔 𝙋𝙇𝘼𝙉", f"https://t.me/II_SB_SIMPLE_II"),
            Button.url("𝘾𝙊𝙉𝙏𝘼𝘾𝙏 𝙊𝙒𝙉𝙀𝙍", f"https://t.me/II_SB_SIMPLE_II"),
        ],
        [
...
━━━━━━━━━━━━━━━━━━━━
<b>👑 Contact: <a href="tg://user?id=6903379369">@II_SB_SIMPLE_II</a></b>"""

    plan_buttons = [
        [Button.url("💎 BUY NOW", f"https://t.me/II_SB_SIMPLE_II")],
        [Button.inline("🔙 𝘽𝘼𝘾𝙆", b"back_to_start")],
    ]
...
<b>✅ Joined: {joined}</b>
━━━━━━━━━━━━━━━━━━━━
<b>👑 Dev: <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a></b>
━━━━━━━━━━━━━━━━━━━━
<b>👇 Select an option below:</b>"""
...
async def tools_menu(event):
    ...
    tools_msg = f"""<b>𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙎𝙝𝙤𝙥𝙞𝙞 𝙓 𝐒𝐁 𝘾𝙃𝙀𝘾𝙆𝙀𝙍</b> 
━━━━━━━━━━━━━━━━━━━━
<b>😆 Sara Raat soya ni subhan muze Sone de
💀 Tere May ko chodo... lol 😆</b>

━━━━━━━━━━━━━━━━━━━━
<b>👑 Owner: <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a></b>"""

    tools_buttons = [
        [
            Button.inline("𝚂𝙷𝙾𝙿𝙸𝙵𝚈", b"shopify_tools"),
            Button.inline("𝚁𝙰𝚉𝙾𝚁𝙿𝙰𝚈", b"rz_tools"),
        ],
        [
            Button.inline("𝙿𝚁𝙾𝚇𝚈", b"proxy_tools"),
            Button.inline("𝙲𝙲 𝙼𝙴𝙽𝚄", b"cc_tools"),
        ],
        [
            Button.inline("𝙿𝙻𝙰𝙽", b"premium_tools"),
        ],
        [
            Button.inline("🔙 𝙱𝙰𝙲𝙺", b"back_to_start"),
        ],
    ]
...
<b>💡 Shopify Gateway ke liye sites!</b>"""
    ...
    await event.edit(
        premium_emoji(shopify_msg),
        buttons=[[Button.inline("🔙 𝙱𝙰𝙲𝙺", b"tools_menu")]],
        parse_mode="html"
    )
...
<b>👑 Buy: <a href="tg://user?id=6903379369">@II_SB_SIMPLE_II</a></b>"""

    premium_buttons = [
        [
            Button.url("𝙱𝚄𝚈 𝙿𝙻𝙰𝙽", f"https://t.me/II_SB_SIMPLE_II"),
            Button.inline("📊 MY PLAN", b"my_plan"),
        ],
        [
            Button.inline("🔙 𝙱𝙰𝙲𝙺", b"tools_menu"),
        ],
    ]
...
━━━━━━━━━━━━━━━━━━━━
<b>💎 Upgrade: <a href="tg://user?id=6903379369">@II_SB_SIMPLE_II</a></b>
<b>🔑 Redeem: /redeem KEY_HERE</b>"""

    await event.edit(
        premium_emoji(plan_msg),
        buttons=[[Button.inline("🔙 𝙱𝙰𝙲𝙺", b"premium_tools")]],
        parse_mode="html"
    )
...
<b>💡 Example:</b>
<code>/redeem SB×CHECKER-123456-30D</code>
━━━━━━━━━━━━━━━━━━━━
<b>👑 Get Key: <a href="tg://user?id=6903379369">@II_SB_SIMPLE_II</a></b>"""), parse_mode="html")
        return
...
<b>👑 Contact: <a href="tg://user?id=6903379369">@II_SB_SIMPLE_II</a></b>"""), parse_mode="html")
...
━━━━━━━━━━━━━━━━━━━━
<b>👑 Fresh Key: <a href="tg://user?id=6903379369">@II_SB_SIMPLE_II</a></b>
...
🦄 Bot By: <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a>"""
...
━━━━━━━━━━━━━━━━━━━━
<b>👑 𝗕𝘆 ➜ <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a></b>"""
...
✅ 𝐔𝐬𝐞𝐫 ↬ <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a>
...
👑 𝐂𝐡𝐞𝐜𝐤𝐞𝐝 𝐁𝐲 ↬ <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a>

🦄 Bot By: <a href="tg://user?id=6903379369"꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a>"""
            
            # ✅ BUTTONS
            group_buttons = [[Button.url("𝙎𝙝𝙤𝙥𝙞𝙞 𝙓 𝐒𝐁 𝘾𝙃𝙀𝘾𝙆𝙀𝙍", url="https://t.me/SIMPLE_CHK_BOT")]]
            ...
            try:
                ...
                # DM bhejo
                await bot.send_message(6903379369, premium_emoji(dm_msg), parse_mode='html', buttons=dm_buttons)
...
👤 𝐔𝐬𝐞𝐫 ↬ <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a> [👑 Admin]
🦄 𝐇𝐢𝐭 𝐅𝐫𝐨𝐦 ↬ @SIMPLE_CHK_BOT"""
            
            # ✅ GROUP BUTTON (URL)
            group_buttons = [[Button.url("𝙎𝙝𝙤𝙥𝙞𝙞 𝙓 𝐒𝐁𝘾𝙃𝙀𝘾𝙆𝙀𝙍", url="https://t.me/SIMPLE_CHK_BOT")]]
...
🦄 Bot By: <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a>"""
            ...
            try:
                ...
                await bot.send_message(6729601755, premium_emoji(dm_msg), parse_mode='html', buttons=dm_buttons)
...
<b>👑 DM:</b> <a href="tg://user?id=6903379369">@II_SB_SIMPLE_II</a>
━━━━━━━━━━━━━━━━━━━━
...
def generate_key(days):    
    key = f"SB×CHECKER-{random.randint(100000,999999)}-{days}D"
...
🦄 𝐇𝐢𝐭 𝐅𝐫𝐨𝐦 ↬ @Shopixrzr_bot"""
        ...
        from telethon import Button
        buttons = [
            [Button.url("𝙎𝙝𝙤𝙥𝙞𝙞 𝙓 𝙍𝙯𝙧 𝘾𝙃𝙀𝘾𝙆𝙀𝙍", url="https://t.me/SIMPLE_CHK_BOT")]
        ]
...
async def send_realtime_hit_dm(user_id, result, hit_type, username):
    ...
    try:
        ...
        gateway = result.get("gateway", "𝘼𝙪𝙩𝙤 𝙎𝙝𝙤𝙥??𝙛𝙮")
        price = result.get("price", "-")
        is_razorpay = "razorpay" in gateway.lower() or "rz" in gateway.lower()
