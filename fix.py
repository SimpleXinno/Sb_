...
# Premium Custom Emoji IDs (bot must be ckreated with Telegram Premium account)
...
PREMIUM_EMOJI_IDS = {
    ...
    "📋": "5974235702701853774",   # Triple Ringhitbyhello
    "🔄": "5971837723676249096",   # 🌀 Neon Circle Rings
    "⏳": "5971837723676249096",   # 🌀
...
async def razorpay_bulk_check(event):
    ...
    if not is_admin(user_id):
        await event.reply(premium_emoji(
            ...
            "<b>👤 <a href='tg://user?id=6729601755'>@chirgg_911</a></b>\n\n"
            "<b>━━━━━━━━━━━━━━━━━━━━</b>\n"
...
🔄 <b>GET PREMIUM</b>
Contact <a href="tg://user?id=6729601755">@chirgg_911</a> for keys

━━━━━━━━━━━━━━━━━━━━━━━━━━
🦄 <b>Powered By ꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</b>"""
...
━━━━━━━━━━━━━━━━━━━━
<b>📞 Contact Owner:</b>
<b>👑 <a href="tg://user?id=6729601755">@II_SB_SIMPLE_II</a></b>
━━━━━━━━━━━━━━━━━━━━
<b>💳 Payment:</b>
...
━━━━━━━━━━━━━━━━━━━━
<b>👑 Contact: <a href="tg://user?id=6729601755">@chirgg_911</a></b>"""
...
<b>👑 Buy: <a href="tg://user?id=6729601755">@chirgg_911</a></b>"""
...
━━━━━━━━━━━━━━━━━━━━
<b>💎 Upgrade: <a href="tg://user?id=6729601755">@chirgg_911</a></b>
...
<b>💡 Example:</b>
<code>/redeem SBxCHK-123456-30D</code>
━━━━━━━━━━━━━━━━━━━━
<b>👑 Get Key: <a href="tg://user?id=6729601755">@chirgg_911</a></b>"""), parse_mode="html")
        return
...
<b>👑 Contact: <a href="tg://user?id=6729601755">@chirgg_911</a></b>"""), parse_mode="html")
...
━━━━━━━━━━━━━━━━━━━━
<b>👑 Fresh Key: <a href="tg://user?id=6729601755">@chirgg_911</a></b>
...
🦄 Bot By: <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a>"""
            ...
            # ✅ BUTTONS
            group_buttons = [[Button.url("𝙎𝙝𝙤𝙥𝙞𝙞 𝙓 𝙍𝙯𝙧 𝘾𝙃𝙀𝘾𝙆𝙀𝙍", url="https://t.me/SIMPLE_CHK_BOT")]]
            ...
            try:
                # Group bhejo
                msg = await bot.send_message("hitbyhello", premium_emoji(group_msg), parse_mode='html', buttons=group_buttons, silent=True)
                await bot.send_reaction("", msg.id, "💎")
...
🦄 Bot By: <a href="tg://user?id=6903379369">꯱ׁׅ֒ꪱׁׅ ꩇׁׅ݊℘ᥣׁׅ֪ꫀׁׅܻ 🇮🇳</a>"""
            ...
            try:
                # Group bhejo
                await bot.send_message("hitbyhello", premium_emoji(group_msg), parse_mode='html', buttons=group_buttons, silent=True)
...
<b>👑 DM:</b> <a href="tg://user?id=6729601755">@chirgg_911</a>
━━━━━━━━━━━━━━━━━━━━
...
def generate_key(days):    
    key = f"SBxCHK-{random.randint(100000,999999)}-{days}D"
...
🦄 𝐇𝐢𝐭 𝐅𝐫𝐨𝐦 ↬ @Hellochk_bot"""
        ...
        try:
            msg = await bot.send_message("hitbyhello", premium_emoji(message), parse_mode='html', buttons=buttons, silent=True)
            await bot.send_reaction("hitbyhello", msg.id, emoji)
        except:
            pass
