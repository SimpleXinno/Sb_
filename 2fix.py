...
<b>👇 Select an option below:</b>"""
        ...
        main_buttons = [
            ...
            [
                Button.url("  𝙐𝙋𝘿𝘼𝙏𝙀𝙎 📣  ", f"https://t.me/YorichiFeedback"),
                Button.url("  𝙂𝙍𝙊𝙐𝙋 💭  ", f"https://t.me/+WWVT9VSC0nc4NjI1"),
            ],
        ]
...
<b>⚠️ Dono channel join karo fir verify karo!</b>"""
        ...
        join_buttons = [
            [Button.url(" 𝙂𝙍𝙊𝙐𝙋 💭 ", f"https://t.me/+WWVT9VSC0nc4NjI1")],
            [Button.url(" 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 📣 ", "https://t.me/YorichiFeedback")],
...
async def verify_handler(event):
    ...
    # Channel 2 check
    try:
        ch2 = await bot.get_entity("https://t.me/YorichiFeedback")  # Ya tera channel entity
...
<b>💡 Example:</b>
<code>/redeem CHIRAG×CHECKER-123456-30D</code>
━━━━━━━━━━━━━━━━━━━━
...
def generate_key(days):    
    key = f"CHIRAG×CHECKER-{random.randint(100000,999999)}-{days}D"
